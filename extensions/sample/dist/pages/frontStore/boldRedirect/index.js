...
export default async function boldRedirectIndex(request, response, next) {
    ...
    let homeUrl = getContextValue(request, 'homeUrl', '');
    ...
    setContextValue(request, 'boldMissingConfiguration', JSON.stringify(missingConfiguration));
    setContextValue(request, 'boldPayload', JSON.stringify({
        orderId: order.uuid,
