...
export default function OperationsGuide() {
    return (React.createElement(GuidePanel, { title: "Atributos operativos recomendados", intro: "Los atributos sostienen filtros, variantes y consistencia futura. En Paralel ya existe un set base para que la operacion no invente nombres distintos en cada carga.", items: [
            {
                title: 'Base minima',
