...
export default function OperationsGuide() {
    return (React.createElement(GuidePanel, { title: "Reglas para categorias", intro: "Las categorias son la fuente de verdad para URLs y navegacion principal. No mezcles categorias con atributos si no necesitas SEO o una landing real.", items: [
            {
