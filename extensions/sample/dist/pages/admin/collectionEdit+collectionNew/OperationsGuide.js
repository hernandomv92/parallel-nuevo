...
export default function OperationsGuide() {
    return (React.createElement(GuidePanel, { title: "Cuando usar colecciones", intro: "Las colecciones son para campanas, marcas destacadas, drops o narrativas editoriales. No reemplazan categorias ni atributos.", items: [
            {
                title: 'Base actual',
