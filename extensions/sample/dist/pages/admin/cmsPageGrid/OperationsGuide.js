...
export default function OperationsGuide() {
    return (React.createElement(GuidePanel, { title: "Paginas CMS", intro: "Usa paginas CMS para textos estaticos y soporte. En esta fase ya existe una base repetible para que negocio no arranque desde cero cada vez.", items: [
            {
            ...
            },
            {
                ...
                description: 'Estas paginas alimentan footer, soporte y confianza comercial. Si falta una politica clave, el cliente lo nota antes de comprar.'
            }
        ] }));
}
export const layout = {
